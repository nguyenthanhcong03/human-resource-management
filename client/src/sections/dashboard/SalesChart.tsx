    ...
    <MainCard sx={{ mt: 1 }} content={false}>
      <Box sx={{ p: 2.5, pb: 0 }}>
        ...
        <BarChart
          ...
          xAxis={[
            { id: 'sales-x-axis', data: labels, scaleType: 'band', tickLabelStyle: { ...axisFonstyle, fontSize: 12 } }
          ]}
          yAxis={[{ disableLine: true, disableTicks: true, tickMaxStep: 20, tickLabelStyle: axisFonstyle }]}
          series={data
            .filter(
              (series) =>
                (series.label === 'Income' && showIncome) || (series.label === 'Cost of Sales' && showCostOfSales)
            )
